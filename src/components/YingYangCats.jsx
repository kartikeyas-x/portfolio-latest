...
const YinYangCats = () => {
  ...
  return (
    <div className="fixed top-4 right-4 z-50 w-16 h-16 cursor-pointer">
      <div className="relative w-full h-full rounded-full overflow-hidden" style={{clipPath: 'circle(50% at 50%)'}}>
        <div 
          className={`absolute w-full h-full transition-colors duration-500 ${hoverSide === 'white' ? 'bg-black' : hoverSide === 'black' ? 'bg-white' : 'bg-transparent'}`}
        />
        ...
        <svg 
          ...
          className={`absolute w-full h-full transition-transform duration-500 ease-in-out
            ${hoverSide === 'white' ? 'translate-x-[45px] translate-y-[95px] scale-[1.4] rotate-180' : 
              hoverSide === 'black' ? 'translate-x-[45px] translate-y-[95px] scale-[1.4] rotate-0' : ''}`}
        >
