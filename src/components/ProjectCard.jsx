...
//       {/* Project Image */}
//       <div className="mb-4 overflow-hidden rounded-sm relative z-10 transition-all duration-300 
...
//         <h3 className="text-xl font-light text-[#4a3f35] dark:text-[#e8e3d9] mb-2 
//           transition-all duration-300 
//           group-hover:translate-x-1 group-hover:text-opacity-90">
//           {title}
//         </h3>
//         <p className="text-sm text-[#665544] dark:text-[#bdb7ae] mb-3 
//           transition-all duration-300 
